...
#+BEGIN_SRC js
  javascript:location.href = 'org-protocol://capture-eww-readable://w/' + encodeURIComponent(location.href) + '/' + encodeURIComponent(document.title || "[untitled page]") + '/';
#+END_SRC
...
#+BEGIN_SRC js
  ...
  map -modes=n,v ce -javascript location.href='org-protocol://capture-eww-readable://w/'+encodeURIComponent(content.location.href)+'/'+encodeURIComponent(content.document.title || "[untitled page]") + '/';
#+END_SRC
