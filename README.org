...
* Contents :TOC:
 ...
 - [[#to-do][To-Do]]
    - [[#register-emacsclientemacs-as-the-org-protocol-link-handler-in-your-de][Register emacsclient/emacs as the =org-protocol= link handler in your DE]]
      - [[#under-linux][Under Linux]]
        - [[#for-kde4][For KDE4]]
          - [[#note-this-is-a-workaround-to-issue-16---see-comment][Note: This is a workaround to issue #16 - See comment]]
...
*** Register emacsclient/emacs as the =org-protocol= link handler in your DE
    :PROPERTIES:
...
**** Under Linux
     :PROPERTIES:
     :CUSTOM_ID: under-linux
     :END:

For KDE Plasma 5 - first see if [KDE5 feature request](https://bugs.kde.org/show_bug.cgi?id=401604) resolved - if so
use `System Settings -> Applications`.
...
****** Note: This is a workaround to issue #16 - See comment
[[https://github.com/sprig/org-capture-extension/issues/16#issuecomment-305050310][here]]
       :PROPERTIES:
       :CUSTOM_ID: note-this-is-a-workaround-to-issue-16---see-comment-here
       :END:
